...
if ($acao == "salvar")
{
    ...
    $SQL .= "vl_quantidade='".addslashes($_REQUEST['vl_quantidade'])."',	 ";
	...
	{
		$SQL  = "Insert into produtos (ds_produto,ds_unidade,ds_categoria,vl_quantidade,ds_cor) "   ; 
		$SQL .= "VALUES ('".addslashes($_REQUEST['ds_produto'])."',";
		$SQL .= "'".addslashes($_REQUEST['ds_unidade'])."',";
    $SQL .= "'".addslashes($_REQUEST['ds_categoria'])."',";
    $SQL .= "'".addslashes($_REQUEST['vl_quantidade'])."',";
        ...
        <form class="needs-validation" novalidate action="menu.php">
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="vl_quantidade" name="vl_quantidade" placeholder="cor" value="<?php echo $RS["vl_quantidade"]; ?>" required>
            </div>
            ...
            <div class="col-sm-4">
              ...
              <input type="text" class="form-control" id="ds_categoria" name="ds_categoria" placeholder="sua cor" value="<?php echo $RS["ds_categoria"]; ?>" required>
            </div>
