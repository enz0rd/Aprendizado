...
<html lang="en">
  <head>
    ...
    <title>Sistema JP Concórdia</title>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a <?php if ($modulo=="dashboard") { echo " class='nav-link active' aria-current='page'"; } else { echo " class='nav-link' "; } ?>
              href="menu.php?modulo=dashboard">
    ...
    <?php 
      if (strlen($modulo)==0) { $modulo = "dashboard"; }
      include $modulo.".php";
    ?>
